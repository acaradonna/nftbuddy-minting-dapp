...
function App() {
  ...
  const claimNFTs = () => {
    ...
    let toAddress = blockchain.account;
    let tokenURI = "QmQrSABxFfpWdmTh2ee1uikgTS1oQKSMwUPaRDe3HHxU5y"
    console.log("Account: ")
    console.log("Cost: ", totalCostWei);
    console.log("Gas limit: ", totalGasLimit);
    setFeedback(`Minting your ${CONFIG.NFT_NAME}...`);
    setClaimingNft(true);
    setFeedback(`Giving your  ${CONFIG.NFT_NAME} that special sauce...`);
    
    // Create Image
    var shell = require("shelljs");
    shell.exec("echo shell.exec works");
    shell.exec("npm run generateArt");
    //jic.compress(img);

    // Upload image and Metadata to IPFS
    let finalCID = storeNFT(`/build/images/${data.totalSupply}.png`, )
